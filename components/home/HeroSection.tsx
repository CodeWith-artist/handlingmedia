...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full mt-20 md:mt-0   md:min-h-screen bg-black flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col mditems-center justify-center text-center px-4 ">
